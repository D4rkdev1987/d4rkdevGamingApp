...
class Blog extends Component {
  ...
  getBlogItems() {
    ...
    axios.get(`https://bennicklaus.devcamp.space/portfolio/portfolio_blogs?page=${this.state.currentPage}`, {
      withCredentials: true
    }).then(response => {
      this.setState({
      ...
      console.log("getting a bad error", error)
    })
  }
